...
fn regexp_split_varchar_joniregexp_simplify(args: Vec<Expr>, _info: &dyn SimplifyInfo) -> Result<ExprSimplifyResult> {
...
impl ScalarUDFImpl for regexp_split_varchar_joniregexpFunc {
