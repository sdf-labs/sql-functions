...
fn ceil_bigint_invoke(_args: &[ColumnarValue]) -> Result<ColumnarValue> {
...
fn ceil_decimal_p_s_simplify(args: Vec<Expr>, _info: &dyn SimplifyInfo) -> Result<ExprSimplifyResult> {
    Ok(ExprSimplifyResult::Original(args))
}
