...
fn map_zip_with_map_4_8_map_4_7_function_4_8_7_6_invoke(
    _args: &[ColumnarValue],
...
fn map_zip_with_map_4_8_map_4_7_function_4_8_7_6_return_type(
    _arg_types: &[DataType],
) -> Result<DataType> {
    Err(DataFusionError::NotImplemented(format!(
        "Not implemented {}:{}",
...
fn map_zip_with_map_4_8_map_4_7_function_4_8_7_6_simplify(
    args: Vec<Expr>,
