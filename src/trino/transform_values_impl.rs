...
fn transform_values_map_4_8_function_4_8_7_invoke(
    _args: &[ColumnarValue],
...
fn transform_values_map_4_8_function_4_8_7_return_type(
    _arg_types: &[DataType],
) -> Result<DataType> {
    Err(DataFusionError::NotImplemented(format!(
        "Not implemented {}:{}",
...
fn transform_values_map_4_8_function_4_8_7_simplify(
    args: Vec<Expr>,
