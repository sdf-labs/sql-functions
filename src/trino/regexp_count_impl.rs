...
fn regexp_count_varchar_joniregexp_simplify(args: Vec<Expr>, _info: &dyn SimplifyInfo) -> Result<ExprSimplifyResult> {
...
impl ScalarUDFImpl for regexp_count_varchar_joniregexpFunc {
