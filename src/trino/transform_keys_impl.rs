...
fn transform_keys_map_13_5_function_13_5_12_invoke(
    _args: &[ColumnarValue],
...
fn transform_keys_map_13_5_function_13_5_12_return_type(
    _arg_types: &[DataType],
) -> Result<DataType> {
    Err(DataFusionError::NotImplemented(format!(
        "Not implemented {}:{}",
...
fn transform_keys_map_13_5_function_13_5_12_simplify(
    args: Vec<Expr>,
