...
fn map_filter_map_4_5_function_4_5_boolean_invoke(
    _args: &[ColumnarValue],
...
fn map_filter_map_4_5_function_4_5_boolean_return_type(
    _arg_types: &[DataType],
) -> Result<DataType> {
    Err(DataFusionError::NotImplemented(format!(
        "Not implemented {}:{}",
...
fn map_filter_map_4_5_function_4_5_boolean_simplify(
    args: Vec<Expr>,
