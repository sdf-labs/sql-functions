...
fn line_interpolate_points_geometry_double_invoke(
    _args: &[ColumnarValue],
...
fn line_interpolate_points_geometry_double_return_type(
    _arg_types: &[DataType],
) -> Result<DataType> {
    Err(DataFusionError::NotImplemented(format!(
        "Not implemented {}:{}",
...
fn line_interpolate_points_geometry_double_simplify(
    args: Vec<Expr>,
