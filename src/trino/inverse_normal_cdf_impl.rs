...
fn inverse_normal_cdf_double_double_double_invoke(
    _args: &[ColumnarValue],
...
fn inverse_normal_cdf_double_double_double_return_type(
    _arg_types: &[DataType],
) -> Result<DataType> {
    Err(DataFusionError::NotImplemented(format!(
        "Not implemented {}:{}",
...
fn inverse_normal_cdf_double_double_double_simplify(
    args: Vec<Expr>,
