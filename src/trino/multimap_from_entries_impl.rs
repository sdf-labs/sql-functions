...
fn multimap_from_entries_array_row_c04_c15_invoke(
    _args: &[ColumnarValue],
...
fn multimap_from_entries_array_row_c04_c15_return_type(
    _arg_types: &[DataType],
) -> Result<DataType> {
    Err(DataFusionError::NotImplemented(format!(
        "Not implemented {}:{}",
...
fn multimap_from_entries_array_row_c04_c15_simplify(
    args: Vec<Expr>,
